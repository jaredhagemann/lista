...
-- Only org owners may write files in their org's folder (<orgId>/...).
...
-- Note: the SELECT policy is in 20260507000000_org_images_select_policy.sql so
-- that it can be applied incrementally to environments where this migration
-- was already run without it.
